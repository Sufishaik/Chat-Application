                ...
                <div className="flex items-center justify-between py-3">
                    <div className="flex gap-5 items-center justify-center cursor-pointer" onClick={() => {
                        ...
                        <Avatar className="h-12 w-12  rounded-full overflow-hidden ">
                            {
                                types && types?.image ? <AvatarImage src={`https://chat-application-4std.onrender.com/${types?.image}`} className='object-cover w-full h-full bg-black' /> : <div className={`uppercase h-12 w-12 text-lg boder-[1px] flex items-center justify-center `}>
                                    {
