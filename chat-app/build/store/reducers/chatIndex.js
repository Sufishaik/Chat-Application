...
exports.setSelectedChatType = exports.setSelectedChatMessages = exports.setSelectedChatData = exports.setSelectedChannelContacts = exports.setIsUploading = exports.setFileUploadProgress = exports.setContacts = exports.setChatDetails = exports.setChannelModalState = exports.selectedChatType = exports.selectedChatData = exports.resetUnread = exports.resetMessageCount = exports.closeChat = exports.chatSlice = exports.addchannel = exports.addMessage = exports.addContactDMContact = void 0;
...
const chatSlice = exports.chatSlice = (0, _toolkit.createSlice)({
  name: 'chat',
  initialState,
  reducers: {
    ...
    addContactDMContact: (state, action) => {
      ...
      if (index !== -1 && index !== undefined) {
        ...
        const newContact = {
          ...fromData,
          messageCount: message.sender._id !== userInfo?.id ? 1 : 0,
          // Start count only if sender is not the current user
...
exports.addContactDMContact = addContactDMContact;
exports.selectedChatData = selectedChatData;
exports.selectedChatType = selectedChatType;
exports.setSelectedChatData = setSelectedChatData;
exports.setContacts = setContacts;
exports.setFileUploadProgress = setFileUploadProgress;
exports.closeChat = closeChat;
exports.setSelectedChatMessages = setSelectedChatMessages;
exports.setChannelModalState = setChannelModalState;
exports.addchannel = addchannel;
exports.setSelectedChannelContacts = setSelectedChannelContacts;
exports.setIsUploading = setIsUploading;
exports.setChatDetails = setChatDetails;
exports.setSelectedChatType = setSelectedChatType;
